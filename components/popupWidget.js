            ...
            <Transition
              ...
              <Disclosure.Panel className=" flex flex-col  overflow-hidden left-0 h-full w-full sm:w-[350px] min-h-[250px] sm:h-[600px] border border-gray-300 dark:border-gray-800 bg-white shadow-2xl rounded-md sm:max-h-[calc(100vh-120px)]">
                <div className="flex flex-col items-center justify-center h-32 p-5 bg-indigo-600">
                  <h3 className="text-lg text-white">Hello my Friend?</h3>
                  <p className="text-white opacity-50">
                    I try to respond fairly quickly!
                  </p> 
                </div>
                <div className="flex-grow h-full p-6 overflow-auto bg-gray-50 ">
                  {!isSubmitSuccessful && (
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      <input
                        type="hidden"
                        value="552a8a74-dd3f-4bd5-8b1f-e0414ace4454"
                        {...register("apikey")}
                      />
                      <input
                        type="hidden"
                        value={`${userName} sent message from HazNextply`}
                        {...register("subject")}
                      />
                      <input
                        type="hidden"
                      ...
                      <div className="mb-4">
                        ...
                        <textarea
                          ...
                          className={`w-full px-3 py-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-300 rounded-md h-28 focus:outline-none focus:ring   ${
                            errors.message
                              ? "border-red-600 focus:border-red-600 ring-red-100"
                              : "border-gray-400 focus:border-indigo-600 ring-indigo-100"
                          }`}
                          required></textarea>
                        {errors.message && (
                          <div className="mt-1 text-sm text-red-400 invalid-feedback">
